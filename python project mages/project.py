...
Wizard = mage(170, 270, 'Wizard', 30, 8, 3)
Evil_wizard1 = mage(500, 250, 'Evil Wizard', 20, 4, 1)
Evil_wizard2 = mage(700, 280, 'Evil Wizard', 20, 4, 1)
...
Evil_wizard1_health_bar = HealthBar(550, screen_height - bottom_panel + 40, Evil_wizard1.hp, Evil_wizard1.max_hp)
Evil_wizard2_health_bar = HealthBar(550, screen_height - bottom_panel + 100, Evil_wizard2.hp, Evil_wizard2.max_hp)  
                ...
                if Evil_wizard.alive == True:
                    ...
                    if action_cooldown >= action_wait_time:
                        ...
                        if (Evil_wizard.hp / Evil_wizard.max_hp) < 0.5 and Evil_wizard.potions > 0:
                            ...
                            if Evil_wizard.max_hp - Evil_wizard.hp > potion_effect:
                                heal_amount = potion_effect
                            else:
